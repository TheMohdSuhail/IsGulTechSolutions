...
const Hero = () => {
  return (
    <section className="flex flex-col items-center justify-center h-screen bg-sky-50">
      <div className="container mx-auto px-4 md:px-11 flex flex-col-reverse md:flex-row items-center justify-center">
        <div className="md:w-1/2 text-center md:text-left mb-8 md:mb-0 text-black">
          <h1 className="text-4xl font-bold mb-4">Welcome to Isgultech Solutions</h1>
          <p className="text-lg">
